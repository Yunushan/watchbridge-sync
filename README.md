...
All **36/36 (100%)** catalog entries are selectable, but that is not 36 direct integrations. Current registry-derived coverage is **11/36 (30.6%)** direct-account platforms, **6/36 (16.7%)** with registered account read/write methods for the primary ratings, watched/progress, and watchlist families, and **27/36 (75%)** with at least one shipped account or file source path. Trakt is the sole **1/36 (2.8%)** direct platform that reads all six families and writes every mutable family; followers are read-only by design. The mutually exclusive workflow catalog is 11 direct-account, 3 dedicated-file, 6 metadata/recommendation, 13 manual-mapping, and 3 restricted services. TMDb overlaps that workflow view in the cross-cutting metadata/recommendation metric, which is **7/36 (19.4%)** after adding Wikidata.

Across the **216** platform × canonical-family slots, **116/216 (53.7%)** source slots are supported and **100/216 (46.3%)** are missing; **29/216 (13.4%)** have verified account writes and **187/216 (86.6%)** do not. Letterboxd's generated import files raise automated target coverage to **33/216 (15.3%)**, with **183/216 (84.7%)** missing. Ratings are **25/36 (69.4%)** source, **9/36 (25%)** account-write, and **10/36 (27.8%)** automated-target; watched/progress is **25/36 (69.4%)**, **10/36 (27.8%)**, and **11/36 (30.6%)**; watchlist is **23/36 (63.9%)**, **8/36 (22.2%)**, and **9/36 (25%)**; reviews are **15/36 (41.7%)**, **1/36 (2.8%)**, and **2/36 (5.6%)**; following is **14/36 (38.9%)**, **1/36 (2.8%)**, and **1/36 (2.8%)**; followers are **14/36 (38.9%)**, **0/36 (0%)**, and **0/36 (0%)**. Run `watchbridge support-summary`, call `GET /v1/support-summary`, or open the web support panel for the live snapshot.
