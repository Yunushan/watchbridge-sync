...
describe('SupportPercentagePanel', () => {
  it('renders an honest local snapshot without making a network request', () => {
    ...
    expect(html).toContain('67.5% without direct account sync');
    ...
    expect(html).toContain('240 executable-family slots');
    ...
    expect(html).toContain('26/40 (65%)');
    expect(html).toContain('10/40 (25%)');
